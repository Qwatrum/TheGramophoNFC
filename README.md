...
5. Build everything together (glue the rfid holder under the top, put the small pipe onto the motor, stabalize the motor on its podest, glue the top and the desk together and put them in the main part and glue it together) and make sure it works and be careful!
6. Enjoy it
